...
class SentencesFeaturesExtractorBase(IFeaturesExtractor):
    ...
    @abstractmethod
    def extract_features_from_sentences(self, debate, sentences_list_list):
        """
    ...
    def extract_features(self, debate, speaker):
        return self.extract_features_from_sentences(debate,
            self.split_to_sentences(debate, speaker))

    @staticmethod
    def split_to_sentences(debate, speaker, ignore_meta=True):
